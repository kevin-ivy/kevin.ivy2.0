...
function About() {
    return (
        <section className='p-4 mt-3 d-flex justify-content-center align-items-center flex-wrap flex-md-nowrap' style={{
            backgroundColor: '#eeeefc',
            color: '#445a78'
        }}>
            <div className='m-1 mr-4'>
                <img src={portrait} className='mb-2 mx-auto d-block border rounded-pill' alt='selfportrait'/>
            </div>
            <div className='m-1 p-1' style={{maxWidth: '800px'}}>
